...
/**
 * The <code>Methods</code> initializes Methods that utilize the Method
 * interface based on a "first come, first served" basis.
 * 
...
public class Methods {
	...
	/**
	 * Initializes <code>Methods</code> class utilizing a "preferred" payment
	 * method check before returning the first method that was initialized.
	 * 
	 * @param preferred
	 *            Payment method that is most preferred for this setup.
	 */
	 ...
	 */
	private void _init() {
		this.addMethod("iConomy",
				new net.erbros.Lottery.register.payment.methods.iCo6());
		this.addMethod("iConomy",
				new net.erbros.Lottery.register.payment.methods.iCo5());
		this.addMethod("iConomy",
				new net.erbros.Lottery.register.payment.methods.iCo4());
		this.addMethod("BOSEconomy",
				new net.erbros.Lottery.register.payment.methods.BOSE6());
		this.addMethod("BOSEconomy",
				new net.erbros.Lottery.register.payment.methods.BOSE7());
		this.addMethod("Essentials",
				new net.erbros.Lottery.register.payment.methods.EE17());
		this.addMethod("MultiCurrency",
				new net.erbros.Lottery.register.payment.methods.MCUR());
	}
